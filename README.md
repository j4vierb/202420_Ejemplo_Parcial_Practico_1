# Ejemplo Parcial Práctico 1 - 202520
...
Sí utiliza `mappedBy` recuerde ubicarlo en la clase no dueña de la relación.
En este caso, para la relación medicos y especialidades irá en la clase especialidades.
